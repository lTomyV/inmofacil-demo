...
const ContractTimeline: React.FC<ContractTimelineProps> = ({ data }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div 
          className="relative p-5 rounded-xl bg-red-50 dark:bg-red-900/20 border-2 border-red-200 dark:border-red-800 hover:shadow-lg transition-all cursor-pointer group"
        ...
        <div 
          className="relative p-5 rounded-xl bg-orange-50 dark:bg-orange-900/20 border-2 border-orange-200 dark:border-orange-800 hover:shadow-lg transition-all cursor-pointer group"
        ...
        {/* +60 Días - Azul (Futuro) */}
        <div 
          className="relative p-5 rounded-xl bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 dark:border-blue-800 hover:shadow-lg transition-all cursor-pointer group"
