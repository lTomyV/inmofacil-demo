/**
 * CollectionPulse Component
 * Displays monthly collection progress with visual indicators
 */

import React from 'react';
import { formatCurrency } from '../../utils';

export interface CollectionPulseProps {
  totalExpected: number;
  totalCollected: number;
  percentage: number;
}

export const CollectionPulse: React.FC<CollectionPulseProps> = ({ 
  totalExpected, 
  totalCollected, 
  percentage 
}) => {
